...
export default function NotFound() {
  // Серверный фиксированный вариант иллюстрации (без клиентских мутаций DOM):
  const notFoundImage = getErrorIllustration('404', 'light');
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 px-6 py-12 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl font-bold text-foreground sm:text-5xl">404</h1>
        <p className="text-xl font-semibold text-foreground sm:text-2xl">Page Not Found</p>
